...
public class JsonEventWriter {
  ...
  public static void writeJSON(Writer json, Event event) throws IOException {
    writeVersion1JSON(json, event);
  }

  public static void writeVersion0JSON(Writer json, Event event) throws IOException {
  ...
  public static void writeVersion1JSON(Writer json, Event event) throws IOException {
