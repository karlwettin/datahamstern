...
public class WikipediaTatortsHarvester {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      JsonEventLogWriter eventLog = new JsonEventLogWriter(new File(EventExecutor.getInstance().getInbox(), System.currentTimeMillis() + ".wikipedia-tatorter.events.json")) {
        @Override
